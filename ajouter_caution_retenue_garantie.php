...
$_SESSION['link_nav4'] = "ajouter_caution_retenue_garantie.php";
$_SESSION['breadcrumb_nav1'] = "Accueil";
$_SESSION['breadcrumb_nav2'] = "Marches";
$_SESSION['breadcrumb_nav3'] = "Caution retenue_garantie";
$_SESSION['breadcrumb_nav4'] = "Nouveau caution retenue_garantie";
?>
                        ...
                        <div class="col-lg-12">	
                            <form action="gestion.php" name="frm" method="post" 
                                ...
                                <div class="form-group">
                                    <label class="control-label"><?php echo "Date Caution retenue garantie " ?> : </label>
                                    <input type="date" id="cal_required" 
                                           name="DATE_CAUTION_RETENUE_GARANTIE"  class="form-control"/>
                                </div>
                                <div class="form-group">
