...
$_SESSION['link_nav4'] = "modifier_ordre_reprise.php";
                    ...
                    <div class="row">
                        <div class="col-lg-12">	
                            <form action="gestion.php" name="frm" method="post" 
                                ...
                                <input type="hidden" name="id_valeur" value="<?php echo $_REQUEST['ordre_reprises'] ?>"/>	


                                <input type="hidden" name="id_noms_retour" value="marches,ordre_reprises"/>
                                <input type="hidden" name="id_valeurs_retour" value="<?php echo $_REQUEST['marches'] ?>,<?php echo $_REQUEST['ordre_reprises'] ?>"/>	

                                <div class="form-group">
                                    <label class="control-label"><?php echo "Date " ?> : </label>
                                    <input type="date" id="cal_required" value="<?php echo getValeurChamp('DATE_ORDRE_REPRISE', 'ordre_reprise', 'ID', $_REQUIRED['ordre_reprises']); ?>"
                                           name="DATE_ORDRE_REPRISE"  class="form-control"/>
                                </div>
                                <div class="form-group">
                                    <label class="control-label"><?php echo "N° Ordre d'arrêt" ?> : </label>
                                    <input type="text" id="<?php echo "N_ORDRE_REPRISE" ?>__required"  value="<?php echo getValeurChamp('N_ORDRE_REPRISE', 'ordre_reprise', 'ID', $_REQUIRED['ordre_reprises']); ?>"
                                           name="N_ORDRE_REPRISE"  class="form-control"/>
                                </div>
                                <div class="form-group">
                                    <label class="control-label"><?php echo "Justificatif " ?> : </label>
                                    <input type="text" id="<?php echo "JUSTIFICAION" ?>__required"  value="<?php echo getValeurChamp('JUSTIFICAION', 'ordre_reprise', 'ID', $_REQUIRED['ordre_reprises']); ?>"
